...
class BiometricClient:
    ...
    def generate_registration_options(self, vault: vault_online.VaultOnline) -> Dict[str, Any]:
        ...
        try:
            ...
            rs = vault.keeper_auth.execute_auth_rest(
                rest_endpoint=API_ENDPOINTS['generate_registration'], request=rq, response_type=APIRequest_pb2.PasskeyRegistrationResponse
            )
    ...
    def verify_registration(self, context: KeeperParams, registration_options: Dict[str, Any],
        ...
        try:
            ...
            context.vault.keeper_auth.execute_auth_rest(rest_endpoint=API_ENDPOINTS['verify_registration'], request=rq)
    ...
    def generate_authentication_options(self, context: KeeperParams, purpose: str = 'login') -> Dict[str, Any]:
    ...
    def get_available_credentials(self, vault: vault_online.VaultOnline):
        """Get list of available biometric credentials"""
        try:
            rq = APIRequest_pb2.PasskeyListRequest()
            
            rs = vault.keeper_auth.execute_auth_rest(rest_endpoint=API_ENDPOINTS['get_available_keys'], request=rq, response_type=APIRequest_pb2.PasskeyListResponse)
    ...
    def disable_passkey(self, vault: vault_online.VaultOnline, user_id: int, credential_id: bytes):
        ...
        try:
            ...
            vault.keeper_auth.execute_auth_rest(rest_endpoint=API_ENDPOINTS['disable_passkey'], request=rq)
    ...
    def update_passkey_name(self, vault: vault_online.VaultOnline, user_id: int, credential_id: bytes, friendly_name: str):
        ...
        try:
            ...
            vault.keeper_auth.execute_auth_rest(rest_endpoint=API_ENDPOINTS['update_passkey_name'], request=rq)
