"""
Example: Revoke a shared folder from a team WITHOUT syncing the full vault down.
...
def main() -> None:
    ...
    if not keeper_auth_context:
        print("Login failed. Unable to revoke share.")
        return
    ...
    print(f'Revoked shared folder "{shared_folder_uid}" from team "{team_name_or_uid}" via skip-sync.')
