"""
Example: Share a shared folder to a team WITHOUT syncing the full vault down.
...
def main() -> None:
    ...
    # team can be either team UID (base64url) or team name; skip_sync will resolve it
    team_name_or_uid = "<team_uid_or_name>"

    # Optional share options
    manage_users = False   # allow this team to manage other users in the shared folder
    manage_records = False # allow this team to manage records in the shared folder
