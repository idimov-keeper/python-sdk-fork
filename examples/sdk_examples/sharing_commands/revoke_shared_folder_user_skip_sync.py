"""
Example: Revoke a shared folder from a user WITHOUT syncing the full vault down.
...
def main() -> None:
    ...
    print(f'Revoked shared folder "{shared_folder_uid}" from user "{username}" via skip-sync.')
