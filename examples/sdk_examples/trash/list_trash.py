...
def list_trash_items(keeper_auth_context: keeper_auth.KeeperAuth):
...
def main():
    """Main function to orchestrate login and list trash items."""
    keeper_auth_context, _ = login()
    if keeper_auth_context:
        list_trash_items(keeper_auth_context)
