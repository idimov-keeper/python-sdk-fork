...
def restore_trash_items(keeper_auth_context: keeper_auth.KeeperAuth):
...
def main():
    """Main function to orchestrate login and restore trash items."""
    keeper_auth_context, _ = login()
    if keeper_auth_context:
        restore_trash_items(keeper_auth_context)
