...
def list_secrets_manager_applications(keeper_auth_context: keeper_auth.KeeperAuth):
...
def main():
    """Main function to orchestrate login and list Secrets Manager applications."""
    keeper_auth_context, _ = login()
    if keeper_auth_context:
        list_secrets_manager_applications(keeper_auth_context)
