...
def display_enterprise_teams(keeper_auth_context: keeper_auth.KeeperAuth):
    ...
    try:
        ...
        print("Enterprise Teams Information")
        print("=" * 100)
...
def main():
    """
    Main entry point for the enterprise info team script.
    Performs login and displays enterprise teams information.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        display_enterprise_teams(keeper_auth_context)
    else:
