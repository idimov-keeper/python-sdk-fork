...
def display_enterprise_roles(keeper_auth_context: keeper_auth.KeeperAuth):
    """
    Load and display enterprise roles information.
    ...
    try:
        ...
        print("Enterprise Roles Information")
        print("=" * 100)
        ...
        for role in enterprise.enterprise_data.roles.get_all_entities():
            ...
            team_count = len(list(enterprise.enterprise_data.role_teams.get_links_by_subject(role.role_id)))
...
def main():
    """
    Main entry point for the enterprise info role script.
    Performs login and displays enterprise roles information.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        display_enterprise_roles(keeper_auth_context)
    else:
