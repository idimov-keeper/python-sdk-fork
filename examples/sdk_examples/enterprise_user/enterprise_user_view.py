...
def view_enterprise_users(keeper_auth_context: keeper_auth.KeeperAuth):
    """
    View enterprise user details with optional search.
...
def main():
    """
    Main entry point for the enterprise user view script.
    Performs login and displays enterprise user details.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        view_enterprise_users(keeper_auth_context)
    else:
