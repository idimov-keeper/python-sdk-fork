...
def list_shared_folders(keeper_auth_context: keeper_auth.KeeperAuth):
    """
    List all shared folders in the vault with optional search.
...
def main():
    """
    Main entry point for the list shared folders script.
    Performs login and lists shared folders.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        list_shared_folders(keeper_auth_context)
    else:
        print("Login failed. Unable to list shared folders.")
