...
def move_folder(keeper_auth_context: keeper_auth.KeeperAuth):
    """
...
def main():
    """
    Main entry point for the move folder script.
    Performs login and moves a folder.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        move_folder(keeper_auth_context)
    else:
        print("Login failed. Unable to move folder.")
