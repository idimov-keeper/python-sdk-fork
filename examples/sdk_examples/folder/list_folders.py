...
def list_folders(keeper_auth_context: keeper_auth.KeeperAuth):
    """
    List all folders in the vault with optional search.
...
def main():
    """
    Main entry point for the list folders script.
    Performs login and lists folders.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        list_folders(keeper_auth_context)
    else:
        print("Login failed. Unable to list folders.")
