...
def get_record(keeper_auth_context: keeper_auth.KeeperAuth):
    """
    Get and display record details from the vault.
...
def main():
    """
    Main entry point for the get record script.
    Performs login and displays record details.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        get_record(keeper_auth_context)
    else:
        print("Login failed. Unable to get record.")
