...
def view_record_history(keeper_auth_context: keeper_auth.KeeperAuth):
    """
    View the revision history of a record.
...
def main():
    """
    Main entry point for the record history script.
    Performs login and displays record history.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        view_record_history(keeper_auth_context)
    else:
        print("Login failed. Unable to view record history.")
