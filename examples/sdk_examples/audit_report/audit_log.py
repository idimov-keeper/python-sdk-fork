...
def view_audit_log(keeper_auth_context: keeper_auth.KeeperAuth):
    """
    View the audit log.
...
def main():
    """
    Main entry point for the audit log script.
    Performs login and displays audit log events.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        view_audit_log(keeper_auth_context)
    else:
        print("Login failed. Unable to view audit log.")
