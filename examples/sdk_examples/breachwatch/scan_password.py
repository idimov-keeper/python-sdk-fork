...
def scan_passwords(keeper_auth_context: keeper_auth.KeeperAuth):
    """
    Scan passwords for breaches.
...
def main():
    """
    Main entry point for the scan password script.
    Performs login and scans passwords for breaches.
    """
    keeper_auth_context, _ = login()
    
    if keeper_auth_context:
        scan_passwords(keeper_auth_context)
    else:
        print("Login failed. Unable to scan passwords.")
